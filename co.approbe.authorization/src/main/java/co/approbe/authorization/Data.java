...
//	
	...
	public Data(String id, String identification, String numberId, String expeditionDate, Integer flagExist,
			...
			Boolean reconocer, String habeasData, String tycData, String signatureData, String dateSave,String birthdayDate,String address) {
		super();
		this.id = id;
		this.identification = identification;
		this.numberId = numberId;
	...
	public String toString() {
		return "{\"id\":\"" + id + "\", \"identification\":\"" + identification + "\", \"numberId\":\"" + numberId
				...
				+ statusProceed + "\", \"log\":\"" + log + "\", \"count\":\"" + count + "\", \"countJurad\":\""
				+ countJurad + "\", \"responseJurad\":\"" + responseJurad + "\", \"validJurad\":\"" + validJurad
				+ "\", \"responseExpeditionDateJurad\":\"" + responseExpeditionDateJurad + "\", \"dateSaveJurad\":\""
				+ dateSaveJurad + "\", \"statusJurad\":\"" + statusJurad + "\", \"validCellphone\":\"" + validCellphone
				+ "\", \"reconocer\":\"" + reconocer + "\", \"habeasData\":\"" + habeasData + "\", \"tycData\":\""
				+ tycData + "\", \"signatureData\":\"" + signatureData + "\", \"dateSave\":\"" + dateSave + "\"}";
	}
