...
public class InformationPowwi {
	...
	public InformationPowwi(String numberId, String idCuenta, String tokenTransaccional, String dateUpdate,
			String dateCreate, String huella, String names, String lastname, String expeditionDate, String birthDate,
			String email, String tokenConsulta, String idOperacion) {
		super();
		this.numberId = numberId;
		this.idCuenta = idCuenta;
		this.tokenTransaccional = tokenTransaccional;
