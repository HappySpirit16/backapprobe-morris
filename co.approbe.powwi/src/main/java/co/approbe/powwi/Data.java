...
//	
	...
	public int getCountPowwi() {
		return countPowwi;
	}

	public void setCountPowwi(int countPowwi) {
		this.countPowwi = countPowwi;
	}
	...
	public Data(String id, String identification, String numberId, String expeditionDate, Integer flagExist,
			...
			Boolean reconocer, String habeasData, String tycData, String signatureData, String dateSave,int countPowwi) {
		super();
		this.id = id;
		this.identification = identification;
		this.numberId = numberId;
	...
	public String toString() {
		return "Data [id=" + id + ", identification=" + identification + ", numberId=" + numberId + ", expeditionDate="
				+ expeditionDate + ", flagExist=" + flagExist + ", countExperian=" + countExperian + ", names=" + names
				+ ", lastName=" + lastName + ", cellphone=" + cellphone + ", gender=" + gender + ", email=" + email
				+ ", habeas=" + habeas + ", tyc=" + tyc + ", firm=" + firm + ", fail=" + fail + ", statusFail="
				+ statusFail + ", statusProceed=" + statusProceed + ", log=" + log + ", count=" + count
				+ ", countJurad=" + countJurad + ", responseJurad=" + responseJurad + ", validJurad=" + validJurad
				+ ", responseExpeditionDateJurad=" + responseExpeditionDateJurad + ", dateSaveJurad=" + dateSaveJurad
				+ ", statusJurad=" + statusJurad + ", validCellphone=" + validCellphone + ", reconocer=" + reconocer
				+ ", habeasData=" + habeasData + ", tycData=" + tycData + ", signatureData=" + signatureData
				+ ", dateTime=" + dateTime + ", dtformat=" + dtformat + ", dateSave=" + dateSave + ", countPowwi="
				+ countPowwi + "]";
	}
