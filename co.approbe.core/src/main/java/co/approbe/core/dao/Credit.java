...
public class Credit {
	...
	public Credit(String id, String numberIdBorrower, String numberIdMoneylender, String dateSaveBD,
			String fechaAprobacion, String lastPaymentDate, String nameBorrower, double ranking, double active,
			String gender, String activityBorrower, String warranty, String plannerPay, double saldoCredito,
			double approveValue, double rateApprobe, double feesApprobe, double gainAprrobe, int statusCredit,
			double feesPaid, String nextFeesDate, double nextPaid, double rentabilidad, double balancePaid,
			String customerId, String productNumber, String channel, String creditType, String productType,
			String datePayment, String ammountAprove, String value, String ratePost, String rateInvoice,
			String feesAgree, String feesRegularity, String feesFirstDate, String feesLastDate, String paidLastDate,
			String ammountNextDate, String balance, String coverageFGAValue, String coverageFGAPercentage,
			String chargeOValue, String chargeOPercentage, String causedInterest, String paidInterest,
			String defaultInterest, String causedDefaultInterest, String costCashing, String causedCommission,
			String paidCommission, String causedInsurance, String paidInsurance, String creationDate, String statusDate,
			String ammount, String status, String cycle, String accountingDate, String client,String entityCode, String acountBankPartner,String financier,String baseWarranty,String installmentFee2) {
		super();
		this.id = id;
		this.numberIdBorrower = numberIdBorrower;
		this.numberIdMoneylender = numberIdMoneylender;
	...
	public String toString() {
		return "{\"id\":\"" + id + "\", \"numberIdBorrower\":\"" + numberIdBorrower + "\", \"numberIdMoneylender\":\""
				+ numberIdMoneylender + "\", \"dateSaveBD\":\"" + dateSaveBD + "\", \"fechaAprobacion\":\""
				...
				+ ammount + "\", \"status\":\"" + status + "\", \"cycle\":\"" + cycle + "\", \"installmentFee2\":\"" + installmentFee2 + "\", \"accountingDate\":\""
