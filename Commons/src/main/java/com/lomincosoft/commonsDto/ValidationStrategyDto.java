...
public class ValidationStrategyDto  {
	...
	public double getAmmountCupo() {
		return ammountCupo;
	}
	public void setAmmountCupo(double ammountCupo) {
		this.ammountCupo = ammountCupo;
	}
	...
	public void setJurad(int jurad) {
		this.jurad = jurad;
	}
	@Override
	public String toString() {
	    return "{\"id\":\"" + id + "\", \"amountFinance\":\"" + amountFinance + "\", \"fees\":\"" + fees
	            ...
	            + validationStrategy + "\", \"questionarie\":\""
	            + (questionarie != null ? questionarie.toString() : "null") + "\", \"documents\":\"" + documents
	            + "\",\"datePaid\":\"" + datePaid + "\",\"numCredit\":\"" + numCredit + "\",\"minPaid\":\"" + minPaid
	            + "\",\"fechaCreacion\":\"" + fechaCreacion + "\",\"paid\":\"" + paid + "\"}";
	}
