...
//	
	...
	public int getFlagExist() {
		return flagExist;
	}
	public void setFlagExist(int flagExist) {
		this.flagExist = flagExist;
	}
	public int getCountExperian() {
		return countExperian;
	}
	public void setCountExperian(int countExperian) {
	...
	public BasicInformation(String id, String identification, String numberId, String expeditionDate,
			int flagExist, int countExperian, String names, String lastName, String cellphone, String gender,
			String email, String habeas, String tyc, String firm, String habeasData, String tycData,
			String signatureData, LocalDateTime dateTime, DateTimeFormatter dtformat, String dateSave, String birthdayDate,String address ,String city ) {
		super();
		this.id = id;
		this.identification = identification;
		this.numberId = numberId;
	...
	public String toString() {
		return "{\"id\":\"" + id + "\", \"identification\":\"" + identification + "\", \"numberId\":\"" + numberId
				...
				+ "\", \"habeasData\":\"" + habeasData + "\", \"tycData\":\"" + tycData + "\", \"signatureData\":\""
				+ signatureData + "\", \"dateTime\":\"" + dateTime + "\", \"dtformat\":\"" + dtformat
				+ "\", \"dateSave\":\"" + dateSave + "\"}";
	}
