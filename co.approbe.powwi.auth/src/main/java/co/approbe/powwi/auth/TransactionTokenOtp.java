...
public class TransactionTokenOtp {
	...
	public String toString() {
		return "{\"tokenConvenio\":\"" + tokenConvenio + "\", \"tipoValidacion\":\"" + tipoValidacion
				+ "\", \"tipoTransaccion\":\"" + tipoTransaccion + "\", \"celular\":\"" + celular
				+ "\", \"idCuenta\":\"" + idCuenta + "\", \"idEnrolamiento\":\"" + idEnrolamiento
				+ "\", \"idValidacion\":\"" + idValidacion + "\", \"scoreValidacion\":\"" + scoreValidacion
				+ "\", \"idAutenticacionAliado\":\"" + idAutenticacionAliado + "\", \"otp\":\"" + otp + "\"}";
	}
