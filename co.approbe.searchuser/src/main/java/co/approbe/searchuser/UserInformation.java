...
public class UserInformation {
	...
	public UserInformation(String numberId, String names, String lastName, String gender, String email,
			...
			FinancialInformationAward financialInformationAward, CreditInformation creditInformation) {
		super();
		this.numberId = numberId;
		this.names = names;
		this.lastName = lastName;
	...
	public String toString() {
		return "UserInformation [numberId=" + numberId + ", names=" + names + ", lastName=" + lastName + ", gender="
				...
				+ ", financialInformationAward=" + financialInformationAward + ", creditInformation="
				+ creditInformation + "]";
	}
