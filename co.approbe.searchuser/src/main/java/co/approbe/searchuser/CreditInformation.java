...
public class CreditInformation {
	...
	public String toString() {
		return "CreditInformation [purpose=" + purpose + ", descriptionPurpose=" + descriptionPurpose + ", profession="
				+ profession + ", laborInformation=" + laborInformation + ", pensionInformation=" + pensionInformation
	...
	public static class Freelancer {
		...
		public ComercialCity getComercialCity() {
			return comercialCity;
		}

		public void setComercialCity(ComercialCity comercialCity) {
			this.comercialCity = comercialCity;
		}
