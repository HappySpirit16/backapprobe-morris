...
public class Customer {
	...
	@DynamoDBAttribute
	private double fGA;  // valor fga installment fee 1
	@DynamoDBAttribute
	...
	public Customer(CustomerDto pCustomer) {
		...
		this.direccion=(pCustomer.getDireccion()==null)?"null":pCustomer.getDireccion();;
		this.referencia=(pCustomer.getReferencia()==null)?"NA":pCustomer.getReferencia();
		this.ciudad=(pCustomer.getCiudad()==null)?"null":pCustomer.getCiudad();
		this.ocupacion=(pCustomer.getOcupacion()==null)?"NA":pCustomer.getOcupacion();
		this.installmentFee2=pCustomer.getInstallmentFee2(); 
		this.signature=signature; 
		this.handlingFee=handlingFee; 
		this.birthdayDate=(pCustomer.getBirthdayDate()==null)?" ":pCustomer.getBirthdayDate(); 
		this.googleMaps=(pCustomer.getGoogleMaps()==null)?" ":pCustomer.getGoogleMaps(); 
		this.ammountInsurance=pCustomer.getAmmountInsurance(); 
		this.riskScore=pCustomer.getRiskScore();		
	}
